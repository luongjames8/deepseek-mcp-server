 ...
 */
async function braveSearch(query, maxResults = 10) {
    const apiKey = getBraveApiKey();
    if (!apiKey) {
        throw new Error("BRAVE_API_KEY environment variable is required for web_search. " +
...
End your response with a "Sources:" section listing the relevant URLs.`;
    ...
    try {
        ...
        if (errorMsg.toLowerCase().includes("context") ||
            ...
            return ("[Synthesis failed: context too large]\n" +
            ...
            return ("[Synthesis failed: rate limit]\n" +
